...
@Component
public class AppWsServerAioListener extends WsServerAioListener {
	
	private static Logger log = LoggerFactory.getLogger(AppWsServerAioListener.class);
	...
	public void onBeforeClose(ChannelContext channelContext, Throwable throwable, String remark, boolean isRemove) throws Exception {
		...
		if (wsSessionContext != null && wsSessionContext.isHandshaked()) {
			...
			WsResponse wsResponse = WsResponse.fromText(msg, AppServerConfig.CHARSET);
			//群发
